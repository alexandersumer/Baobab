...
export class EditModal extends React.Component {
  constructor(props) {
    ...
    this.handleCanvasChangeComplete = this.handleCanvasChangeComplete.bind(
      this
    );
  ...
  render() {
    ...
    return (
      <Modal heading={"Customise your canvas here."} autoFocus={true}>
        <div>Select a new canvas background colour.</div>
        <br />
        <ColourPallete
        ...
        >
          <Button appearance={"warning"} onClick={this.defaultColour}>
            Revert to default
          </Button>
        </div>
        <div
        ...
        >
          <ButtonGroup>
            <Button appearance={"primary"} onClick={this.handleClick}>
              Save
            </Button>
        ...
        >
          You must select a colour for all elements to save.
        </div>
        <br />
      </Modal>
    );
